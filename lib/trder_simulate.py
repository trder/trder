...
def simulate_trading_single(trading_system_name, exchange, symbol, init_balance, since, param):
    ...
    while True:
        ...
        for t,o,h,l,c,v in kline_1m:
            ...
            for order in order_list:
                ...
                if exit_sign:
                    ...
                    if profit >= 0:
                        print_log("【盈利退出】时间:"+stamp_to_date(t)+";价格:"+str(c)+"余额:"+format(final_balance,'.6g')+" --> "+format(final_balance + profit,'.6g'),"S")
                    else:
                        print_log("【亏损退出】时间:"+stamp_to_date(t)+";价格:"+str(c)+"余额:"+format(final_balance,'.6g')+" --> "+format(final_balance + profit,'.6g'),"E")
        ...
        print_log("时间:"+ stamp_to_date(last_ts) +";价格:"+str(c)+";ATR:"+format(ATRP,'.4g')+"%;余额:"+format(final_balance,'.6g')+";唐奇安20:["+format(L20,'.6g')+"~"+format(H20,'.6g')+"]               ","I",'\r')
